...
class LyricsSearch:
    def __init__(self, **kwargs):
        ...
        self.results = [LyricsSearchResp(**l) for l in kwargs.get("data")]
...
class Album:
    def __init__(self, **kwargs):
        ...
        self.tracks = [Track(**t) for t in kwargs.get("tracks")] if kwargs.get("tracks") else None
